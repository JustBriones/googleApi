...
$(document).ready(function(){
  ...
  $("#submit1").click(function() {
    ...
    $.getJSON(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?APPID=cd6b90ba80057d06e230432ecdf83865&units=imperial&q=${cityOne}`, (data) => {
      ...
      var city = data.name
      $(".rowLocation1").append(`<div class='row row-item city'>${city}</div>`)
...
$("#submit2").click(function() {
  ...
  $.getJSON(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?APPID=cd6b90ba80057d06e230432ecdf83865&units=imperial&q=${cityTwo}`, (data) => {
    var temp = data.main.temp
    var weather = data.weather[0].description
    var city = data.name
...
$("#submit3").click(function() {
  ...
  $.getJSON(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?APPID=cd6b90ba80057d06e230432ecdf83865&units=imperial&q=${cityThree}`, (data) => {
    var temp = data.main.temp
    var weather = data.weather[0].description
    var city = data.name
